...
/* Add Zoom Animation */
.animate {
  -webkit-animation: animatezoom 0.45s;
  animation: animatezoom 0.45s
}
  ...
  <form class="modal-content animate">
    <div class="container">
      ...
      <div class="clearfix">
        ...
        <button type="submit" class="signupbtn"><a href="Login.jsp" style="text-decoration:none;color:white">Sign Up</button>
      </div>
    </div>
  </form>
</div>
